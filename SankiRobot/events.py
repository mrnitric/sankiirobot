...
from SankiRobot import MONGO_DB_URI
from SankiRobot import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import SankiRobot.events

        path = Path(f"SankiRobot/modules/{shortname}.py")
        name = "SankiRobot.modules.{}".format(shortname)
        ...
        mod.SankiRobot = SankiRobot
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["SankiRobot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "SankiRobot/modules/*.py"
