...
import SankiRobot.modules.sql.notes_sql as sql
from SankiRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from SankiRobot.__main__ import DATA_IMPORT
from SankiRobot.modules.helper_funcs.chat_status import user_admin
from SankiRobot.modules.helper_funcs.alternate import typing_action

# from SankiRobot.modules.rules import get_rules
import SankiRobot.modules.sql.rules_sql as rulessql

# from SankiRobot.modules.sql import warns_sql as warnssql
import SankiRobot.modules.sql.blacklist_sql as blacklistsql
from SankiRobot.modules.sql import disable_sql as disabledsql

# from SankiRobot.modules.sql import cust_filters_sql as filtersql
# import SankiRobot.modules.sql.welcome_sql as welcsql
import SankiRobot.modules.sql.locks_sql as locksql
from SankiRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("SankiRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("SankiRobot{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `SankiRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("SankiRobot{}.backup".format(chat_id))  # Cleaning file
