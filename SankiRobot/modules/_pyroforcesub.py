...
from SankiRobot import DRAGONS as SUDO_USERS
from SankiRobot import pbot
from SankiRobot.modules.sql_extended import forceSubscribe_sql as sql
...
❍ Suzie can mute members who are not subscribed your channel until they subscribe
