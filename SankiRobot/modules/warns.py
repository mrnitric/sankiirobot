...
import telegram
from SankiRobot import TIGERS, WOLVES, dispatcher
from SankiRobot.modules.disable import DisableAbleCommandHandler
from SankiRobot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from SankiRobot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from SankiRobot.modules.helper_funcs.string_handling import split_quotes
from SankiRobot.modules.log_channel import loggable
from SankiRobot.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # Suzie's sticker
        keyboard = None
        log_reason = (
