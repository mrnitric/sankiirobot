# This file is part of Sanki (Telegram Bot)
...
from Sanki.config import get_bool_key, get_int_key, get_list_key, get_str_key
from Sanki.utils.logger import log
from Sanki.versions import Sanki_VERSION

log.info("----------------------")
log.info("|      Sanki      |")
log.info("----------------------")
log.info("Version: " + Sanki_VERSION)
